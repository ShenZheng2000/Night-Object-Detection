...
register_coco_instances("tesla_annotated_train",
{}, 
f'{data_path}/TeslaAnnotated/annotations/train_data.json', 
f'{data_path}/TeslaAnnotated/images')

register_coco_instances("tesla_annotated_test",
{}, 
f'{data_path}/TeslaAnnotated/annotations/test_data.json', 
f'{data_path}/TeslaAnnotated/images')

register_coco_instances("tesla_annotated_train_vehicles_merged",
{}, 
f'{data_path}/TeslaAnnotated/annotations/train_data_vehicles_merged.json', 
f'{data_path}/TeslaAnnotated/images')

register_coco_instances("tesla_annotated_test_vehicles_merged",
{}, 
f'{data_path}/TeslaAnnotated/annotations/test_data_vehicles_merged.json', 
f'{data_path}/TeslaAnnotated/images')                        

register_coco_instances("bdd100k_clear_train_valid_vp_vehicles_merged",
{}, 
f'{data_path}/bdd100k/coco_labels/train_clear_valid_vp_vehicles_merged.json', 
f'{data_path}/bdd100k/images/100k/train')


register_coco_instances("tesla_annotatedv2_test",
{}, 
f'{data_path}/TeslaAnnotatedV2/annotations/test_data_vehicles_merged_with_scene_labels.json', 
f'{data_path}/TeslaAnnotatedV2/images')

register_coco_instances("tesla_annotatedv2_test_snow",
{}, 
f'{data_path}/TeslaAnnotatedV2/annotations/test_data_vehicles_merged_with_scene_labels_subset_Snow.json', 
f'{data_path}/TeslaAnnotatedV2/images')

register_coco_instances("tesla_annotatedv2_test_rain",
{},
f'{data_path}/TeslaAnnotatedV2/annotations/test_data_vehicles_merged_with_scene_labels_subset_Rain.json',
f'{data_path}/TeslaAnnotatedV2/images')

register_coco_instances("tesla_annotatedv2_test_night",
{},
