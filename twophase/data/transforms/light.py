...
# TODO: use cmap=hot from matplotlib to render taillight
...
#             # Randomize wheel_y2
#             # wheel_y2 = random.uniform(wheel_y1, img_h)
#             # print("wheel_y2 is", wheel_y2)
#             wheel_y2 = None
...
#                                                       wei=weight, 
#                                                       device=device, 
#                                                       reflect_render=reflect_render and wheel_c > 0) # NOTE: y->h, x->w
...
#     new_img = (image * (1-aggregate_kernel) + color_white * aggregate_kernel).type(torch.uint8)

#     # NOTE: add light reflected image here 
#     if reflect_render and reflects:
#         aggregate_reflect = torch.clamp(torch.sum(torch.stack(reflects), 0), 0, 1)
#         new_img = (new_img * (1-aggregate_reflect) + color_white * aggregate_reflect).type(torch.uint8)
