...
class TwoPCTrainer(DefaultTrainer):
    ...
    def process_data(self, unlabel_data, unlabel_dep_data=None, record_dict=None, prefix=None):
        ...
        if self.cfg.ONE_STAGE:
            cons_loss = self.consistency_losses.losses(roi_stu,proposals_roih_unsup,prefix)
        else:
            cons_loss = self.consistency_losses.losses(roi_stu,roi_teach,prefix)
    ...
    def run_step_full_semisup(self):
        ...
        # Student-teacher stage
            ...
            record_dict = self.process_data(unlabel_data,
                                            unlabel_dep_data,
                                            record_dict,
                                            prefix='')
            ...
            if self.cfg.USE_MASK:
                ...
                record_dict = self.process_data(unlabel_mask_data,
                                                unlabel_dep_data,
                                                record_dict,
                                                prefix='mask')
