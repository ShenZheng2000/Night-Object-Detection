...
class TwoPCTrainer(DefaultTrainer):
    ...
    def threshold_bbox(self, proposal_bbox_inst, thres=0.7, proposal_type="roih"):
        if proposal_type == "rpn":
            # print("proposal_bbox_inst.objectness_logits is", proposal_bbox_inst.objectness_logits)
            ...
            # print("proposal_bbox_inst.scores is", proposal_bbox_inst.scores)
    ...
    def run_step_full_semisup(self):
        ...
        # NOTE: check the image name is consistency (DONE)
...
class BaselineTrainer(DefaultTrainer):
    ...
    @classmethod
    def build_train_loader(cls, cfg):
        # print("cfg.DATASETS.TRAIN is", cfg.DATASETS.TRAIN)
